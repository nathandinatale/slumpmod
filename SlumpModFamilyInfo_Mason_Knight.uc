...
DefaultProperties
{
	...
	NewTertiaryWeapons(1)=(CWeapon=class'SlumpModWeapon_TowerShield_Mason')
	NewTertiaryWeapons(2)=(CWeapon=class'SlumpModWeapon_Heater_Mason',bEnabledDefault=true)
	NewTertiaryWeapons(3)=(CWeapon=class'SlumpModWeapon_Kite_Mason')
	NewTertiaryWeapons(4)=(CWeapon=class'SlumpModWeapon_Buckler_Mason')
