...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'SlumpModWeapon_Hatchet',CorrespondingDuelProp=EDUEL_HatchetUse)
	NewPrimaryWeapons(4)=(CWeapon=class'SlumpModWeapon_WarAxe',CorrespondingDuelProp=EDUEL_WarAxeUse)
	NewPrimaryWeapons(5)=(CWeapon=class'SlumpModWeapon_Dane',CorrespondingDuelProp=EDUEL_DaneUse)
	NewPrimaryWeapons(6)=(CWeapon=class'SlumpModWeapon_Mace',CorrespondingDuelProp=EDUEL_MaceUse)
	NewPrimaryWeapons(7)=(CWeapon=class'SlumpModWeapon_MorningStar',CorrespondingDuelProp=EDUEL_MorningStarUse)
	NewPrimaryWeapons(8)=(CWeapon=class'SlumpModWeapon_HolyWaterSprinkler',CorrespondingDuelProp=EDUEL_HolyWaterSprinklerUse)
	NewPrimaryWeapons(9)=(CWeapon=class'SlumpModWeapon_QuarterStaff',CorrespondingDuelProp=EDUEL_QStaffUse)
	...
	NewTertiaryWeapons(1)=(CWeapon=class'SlumpModWeapon_OilPot')
	NewTertiaryWeapons(2)=(CWeapon=class'SlumpModWeapon_Buckler_Agatha')
